...
namespace Flee {
	public class Upgrade {
		...
		public static void LoadRegUpgrades() {
			...
			upgrades.Add(new Upgrade() { name = "Ascend", file = "Ups", frame_coords = new Point(7, 7), cost = new MaterialSet(4096L, 64L, 48L, 2048L), delay = 600UL, need = "?Up:Warp_Drive", effect = "!Ascend %Speed:300 %Life:100 !Regen:16 %Wloadmax:-100 !Shield:600 !Shieldop:100 !C:White %Shieldreg:2500", upgrade_slots_requiered = 1, not_for_bots = true, desc = "Warp your mind to an alternative universe and reach the next level of existence." });
