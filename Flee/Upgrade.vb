Public Class Upgrade
    ...
    Public Shared Sub LoadRegUpgrades()
        ...
        Upgrades.Add(New Upgrade With {.Name = "Break_Uranium", .File = "Ups2", .PTN = New Point(7, 7), .cost = New MaterialSet(-1200, -8, 1, 0), .Time = 1, .Need = "?Type:Station", .Effect = "!Fix:1", .Install = False, .Desc = "Sacrifice some Uranium for crystal and metal."})

        'Special
        Upgrades.Add(New Upgrade With {.Name = "Nuke", .File = "Nuke", .PTN = New Point(0, 0), .cost = New MaterialSet(32, 30000, 8, 0), .Time = 250, .Need = "?Type:Ambassador", .Effect = "!Sum:Nuke", .Install = False, .Desc = "When something go wrong, it still can go worse." & vbNewLine & "/!\ Playing with the atom may lead to unexpected results."})
        Upgrades.Add(New Upgrade With {.Name = "Launch_Comet", .File = "Comet", .PTN = New Point(0, 0), .cost = New MaterialSet(16, 2000, 0, 0), .Time = 100, .Need = "?Type:Nothing", .Effect = "!Sum:Comet", .Install = False, .Desc = "Launch a comet you can control"})
        Upgrades.Add(New Upgrade With {.Name = "Launch_MSL", .File = "MSL", .PTN = New Point(0, 0), .cost = New MaterialSet(1, 1000, 0, 0), .Time = 100, .Need = "?Type:Scout", .Effect = "!Sum:MSL", .Install = False, .Desc = "Launch a missile you can control"})
        ...
        Upgrades.Add(New Upgrade With {.Name = "Ascend", .File = "Ups", .PTN = New Point(7, 7), .cost = New MaterialSet(0, 0, 32, 0), .Time = 600, .Need = "?Up:Warp_Drive", .Effect = "!Ascend %Speed:300 %Life:100 !Regen:16 %Wloadmax:-100 !Shield:600 !Shieldop:100 !C:White %Shieldreg:2500", .Install = True, .Desc = "Reach the next level of existence."})
        Upgrades.Add(New Upgrade With {.Name = "Spawn_Kastou", .File = "Kastou", .PTN = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .Time = 1900, .Need = "?Up:Nothing", .Effect = "!Sum:Kastou", .Install = False, .Desc = "Ya kastou itsi vioctry granti" & vbNewLine & "'yi granti!'"})
        Upgrades.Add(New Upgrade With {.Name = "Spawn_Crusher", .File = "Crusher", .PTN = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .Time = 2500, .Need = "?Up:Nothing", .Effect = "!Sum:Crusher", .Install = False, .Desc = "It's gonna hurt!" & vbNewLine & "'Hmm... How could you even read this?'"})
        Upgrades.Add(New Upgrade With {.Name = "Spawn_Ori", .File = "Ori", .PTN = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .Time = 100, .Need = "?Up:Nothing", .Effect = "!Sum:Ori", .Install = False, .Desc = "Hey"})
        ...
        Upgrades.Add(New Upgrade With {.Name = "Summon_Finalizer", .File = "Finalizer", .PTN = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .Time = 600, .Need = "?Up:Ascend", .Effect = "!Sum:Finalizer", .Install = False, .Desc = "Yet, not everybody made it through." & vbNewLine & "We will return for them."})
        ...
        '1->2
        Upgrades.Add(New Upgrade With {.Name = "Scout", .File = "Scout", .PTN = New Point(0, 0), .cost = New MaterialSet(1300, 3, 0, 0), .Time = 300, .Need = "?Type:Simpleship", .Effect = "!Type:Scout", .Install = True, .Desc = "Change into scout ship."})
        Upgrades.Add(New Upgrade With {.Name = "Bomber", .File = "Bomber", .PTN = New Point(0, 0), .cost = New MaterialSet(1600, 3, 0, 0), .Time = 300, .Need = "?Type:Simpleship", .Effect = "!Type:Bomber", .Install = True, .Desc = "Change into attack ship."})
        Upgrades.Add(New Upgrade With {.Name = "Artillery", .File = "Artillery", .PTN = New Point(0, 0), .cost = New MaterialSet(1600, 3, 0, 0), .Time = 300, .Need = "?Type:Simpleship", .Effect = "!Type:Artillery", .Install = True, .Desc = "Change into artillery."})
        Upgrades.Add(New Upgrade With {.Name = "Dronner", .File = "Dronner", .PTN = New Point(0, 0), .cost = New MaterialSet(2000, 5, 0, 0), .Time = 300, .Need = "?Type:Simpleship", .Effect = "!Type:Dronner", .Install = True, .Desc = "Change into ship builder."})
        ...
        Upgrades.Add(New Upgrade With {.Name = "Shield_II", .File = "Ups", .PTN = New Point(3, 1), .cost = New MaterialSet(400, 1, 0, 0), .Time = 100, .Need = "" & NPU(), .Effect = "%Shield:20 !Shieldop:25", .Install = True, .Desc = "Shield stop 50% of the shoots and increase in durability."})
        Upgrades.Add(New Upgrade With {.Name = "Shield_III", .File = "Ups", .PTN = New Point(3, 2), .cost = New MaterialSet(600, 1, 0, 0), .Time = 100, .Need = "" & NPU(), .Effect = "%Shield:20 !Shieldop:25", .Install = True, .Desc = "Shield stop 75% of the shoots and increase in durability."})
        Upgrades.Add(New Upgrade With {.Name = "Shield_IV", .File = "Ups", .PTN = New Point(3, 3), .cost = New MaterialSet(800, 2, 0, 50), .Time = 100, .Need = "" & NPU(), .Effect = "%Shield:20 !Shieldop:25", .Install = True, .Desc = "Shield stop 100% of the shoots and increase in durability"})
        ...
        Upgrades.Add(New Upgrade With {.Name = "Alternative_Shield", .File = "Ups2", .PTN = New Point(1, 3), .cost = New MaterialSet(700, 3, 0, 100), .Time = 100, .Need = "+Lvl:2 ?Up:Shield_Loader", .Effect = "%Shieldreg:25 %Shield:25 !Shieldop:-50", .Install = True, .Desc = "Shield recover 25% faster and last 25% longer, but let 25% of shoot damages pass."})
        ...
        'BASE ups+
        Upgrades.Add(New Upgrade With {.Name = "Space_Shemes", .File = "Ups", .PTN = New Point(4, 0), .cost = New MaterialSet(2000, 2, 0, 0), .Time = 100, .Need = "?Base", .Effect = "!Upsbonus:2", .Install = True, .Desc = "New ships can install 2 additional upgrades."})
        Upgrades.Add(New Upgrade With {.Name = "Space_Shemes_II", .File = "Ups", .PTN = New Point(4, 1), .cost = New MaterialSet(2500, 4, 0, 0), .Time = 100, .Need = "?Base" & NPU(), .Effect = "!Upsbonus:2", .Install = True, .Desc = "New ships can install 2 additional upgrades."})
        Upgrades.Add(New Upgrade With {.Name = "Space_Shemes_III", .File = "Ups", .PTN = New Point(4, 2), .cost = New MaterialSet(3500, 8, 0, 0), .Time = 100, .Need = "?Base" & NPU(), .Effect = "!Upsbonus:2", .Install = True, .Desc = "New ships can install 2 additional upgrades."})
        Upgrades.Add(New Upgrade With {.Name = "Space_Shemes_IV", .File = "Ups", .PTN = New Point(4, 4), .cost = New MaterialSet(5000, 16, 0, 0), .Time = 100, .Need = "?Base" & NPU(), .Effect = "!Upsbonus:2", .Install = True, .Desc = "New ships can install 2 additional upgrades."})
        Upgrades.Add(New Upgrade With {.Name = "Space_Shemes_V", .File = "Ups", .PTN = New Point(4, 3), .cost = New MaterialSet(9000, 16, 0, 0), .Time = 100, .Need = "?Base" & NPU(), .Effect = "!Upsbonus:2", .Install = True, .Desc = "New ships can install 2 additional upgrades."})

        'BASE Spawn
        Upgrades.Add(New Upgrade With {.Name = "Spawn_Cargo", .File = "Cargo", .PTN = New Point(0, 0), .cost = New MaterialSet(1200, 0, 0, 0), .Time = 300, .Need = "?MS ?Type:Station", .Effect = "!Sum:Cargo", .Install = False, .Desc = "Build a weak but fast mining ship." & vbNewLine & "'An overpowered ship.'"})
        Upgrades.Add(New Upgrade With {.Name = "Spawn_Hunter", .File = "Hunter", .PTN = New Point(0, 0), .cost = New MaterialSet(800, 1, 0, 0), .Time = 220, .Need = "?MS ?Type:Station", .Effect = "!Sum:Hunter", .Install = False, .Desc = "Build a light hunter ship."})
        Upgrades.Add(New Upgrade With {.Name = "Spawn_Harass", .File = "Harass", .PTN = New Point(0, 0), .cost = New MaterialSet(950, 2, 0, 0), .Time = 350, .Need = "?MS ?Type:Station", .Effect = "!Sum:Harass", .Install = False, .Desc = "Build a medium hunter ship."})
        Upgrades.Add(New Upgrade With {.Name = "Simpleship", .File = "Simpleship", .PTN = New Point(0, 0), .cost = New MaterialSet(1000, 1, 0, 0), .Time = 380, .Need = "?MS ?Type:Station", .Effect = "!Sum:Simpleship", .Install = False, .Desc = "Build a basic ship that you can upgrade."})
        Upgrades.Add(New Upgrade With {.Name = "Legend_I", .File = "Legend_I", .PTN = New Point(0, 0), .cost = New MaterialSet(1400, 16, 1, 0), .Time = 550, .Need = "?MS ?Type:Station", .Effect = "!Sum:Legend_I", .Install = True, .Desc = "Build a legendary ship." & vbNewLine & "/!\ You can only build this ship once!"})
        Upgrades.Add(New Upgrade With {.Name = "Legend_K", .File = "Legend_K", .PTN = New Point(0, 0), .cost = New MaterialSet(1200, 14, 0, 400), .Time = 550, .Need = "?MS ?Type:Station", .Effect = "!Sum:Legend_K", .Install = True, .Desc = "Build a legendary ship." & vbNewLine & "/!\ You can only build this ship once!"})
        Upgrades.Add(New Upgrade With {.Name = "Legend_L", .File = "Legend_L", .PTN = New Point(0, 0), .cost = New MaterialSet(1300, 15, 0, 400), .Time = 550, .Need = "?MS ?Type:Station", .Effect = "!Sum:Legend_L", .Install = True, .Desc = "Build a legendary ship." & vbNewLine & "/!\ You can only build this ship once!"})
        Upgrades.Add(New Upgrade With {.Name = "Legend_U", .File = "Legend_U", .PTN = New Point(0, 0), .cost = New MaterialSet(1200, 16, 0, 200), .Time = 550, .Need = "?MS ?Type:Station", .Effect = "!Sum:Legend_U", .Install = True, .Desc = "Build a legendary ship." & vbNewLine & "/!\ You can only build this ship once!"})
        Upgrades.Add(New Upgrade With {.Name = "Legend_Y", .File = "Legend_Y", .PTN = New Point(0, 0), .cost = New MaterialSet(1400, 14, 0, 300), .Time = 550, .Need = "?MS ?Type:Station", .Effect = "!Sum:Legend_Y", .Install = True, .Desc = "Build a legendary ship." & vbNewLine & "/!\ You can only build this ship once!"})

        'NPC Spawn
        Upgrades.Add(New Upgrade With {.Name = "Spawn_Dronner", .File = "Dronner", .PTN = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .Time = 750, .Need = "?Up:Nothing", .Effect = "!Sum:Dronner", .Install = False, .Desc = "Construire un constructeur de drones"})
        Upgrades.Add(New Upgrade With {.Name = "Spawn_Scout", .File = "Scout", .PTN = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .Time = 550, .Need = "?Up:Nothing", .Effect = "!Sum:Scout", .Install = False, .Desc = "Construire un vaisseau d'exploration"})
        Upgrades.Add(New Upgrade With {.Name = "Spawn_Bomber", .File = "Bomber", .PTN = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .Time = 550, .Need = "?Up:Nothing", .Effect = "!Sum:Bomber", .Install = False, .Desc = "Construire un vaisseau lourd"})
        Upgrades.Add(New Upgrade With {.Name = "Spawn_Yerka", .File = "Yerka", .PTN = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .Time = 720, .Need = "?Up:Nothing", .Effect = "!Sum:Yerka", .Install = False, .Desc = "Ya Yerka Yi!"})
        Upgrades.Add(New Upgrade With {.Name = "Spawn_Strange", .File = "Strange", .PTN = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .Time = 850, .Need = "?Up:Nothing", .Effect = "!Sum:Strange", .Install = False, .Desc = ""})
        Upgrades.Add(New Upgrade With {.Name = "Spawn_Sacred", .File = "Sacred", .PTN = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .Time = 200, .Need = "?Up:Nothing", .Effect = "!Sum:Sacred", .Install = False, .Desc = ""})
        Upgrades.Add(New Upgrade With {.Name = "Spawn_Artillery", .File = "Artillery", .PTN = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .Time = 270, .Need = "?Up:Nothing", .Effect = "!Sum:Artillery", .Install = False, .Desc = ""})
        Upgrades.Add(New Upgrade With {.Name = "Spawn_MiniColonizer", .File = "MiniColonizer", .PTN = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .Time = 500, .Need = "?Up:Nothing", .Effect = "!Sum:MiniColonizer", .Install = False, .Desc = ""})
        Upgrades.Add(New Upgrade With {.Name = "Spawn_Colonizer", .File = "Colonizer", .PTN = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .Time = 500, .Need = "?Up:Nothing", .Effect = "!Sum:Colonizer", .Install = False, .Desc = ""})
        Upgrades.Add(New Upgrade With {.Name = "Spawn_Converter_A", .File = "Converter_A", .PTN = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .Time = 220, .Need = "?Type:Converter", .Effect = "!Sum:Converter_A", .Install = False, .Desc = ""})
        Upgrades.Add(New Upgrade With {.Name = "Spawn_Converter_B", .File = "Converter_B", .PTN = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .Time = 220, .Need = "?Type:Converter", .Effect = "!Sum:Converter_B", .Install = False, .Desc = ""})

        'Drone Spawn
        Upgrades.Add(New Upgrade With {.Name = "Spawn_Explorer", .File = "Explorer", .PTN = New Point(0, 0), .cost = New MaterialSet(100, 0, 0, 0), .Time = 150, .Need = "?MS ?Type:Dronner", .Effect = "!Sum:Explorer", .Install = False, .Desc = "Build a weak minner drone."})
        Upgrades.Add(New Upgrade With {.Name = "Combat_Drone_1", .File = "Combat_Drone_1", .PTN = New Point(0, 0), .cost = New MaterialSet(370, 0, 0, 0), .Time = 100, .Need = "?MS ?Type:Dronner", .Effect = "!Sum:Combat_Drone_1", .Install = False, .Desc = "Build a combat drone."})
        Upgrades.Add(New Upgrade With {.Name = "Combat_Drone_2", .File = "Combat_Drone_2", .PTN = New Point(0, 0), .cost = New MaterialSet(320, 0, 0, 0), .Time = 100, .Need = "?MS ?Type:Dronner", .Effect = "!Sum:Combat_Drone_2", .Install = False, .Desc = "Build a combat drone."})
        Upgrades.Add(New Upgrade With {.Name = "Combat_Drone_3", .File = "Combat_Drone_3", .PTN = New Point(0, 0), .cost = New MaterialSet(380, 0, 0, 0), .Time = 100, .Need = "?MS ?Type:Dronner", .Effect = "!Sum:Combat_Drone_3", .Install = False, .Desc = "Build a combat drone."})
        Upgrades.Add(New Upgrade With {.Name = "Spawn_Drone", .File = "Drone", .PTN = New Point(0, 0), .cost = New MaterialSet(800, 1, 0, 0), .Time = 150, .Need = "?MS ?Type:Dronner", .Effect = "!Sum:Drone", .Install = False, .Desc = "Summon a big drone."})
        ...
        Upgrades.Add(New Upgrade With {.Name = "Summon_Purger_Dronner", .File = "Purger_Dronner", .PTN = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .Time = 2400, .Need = "?Up:Nothing", .Effect = "!Sum:Purger_Dronner", .Install = False, .Desc = ""})
        Upgrades.Add(New Upgrade With {.Name = "Purger_Drone_1", .File = "Purger_Drone_1", .PTN = New Point(0, 0), .cost = New MaterialSet(400, 0, 0, 0), .Time = 50, .Need = "?MS ?Type:Purger_Dronner", .Effect = "!Sum:Purger_Drone_1", .Install = False, .Desc = "Build a combat drone."})
        Upgrades.Add(New Upgrade With {.Name = "Purger_Drone_2", .File = "Purger_Drone_2", .PTN = New Point(0, 0), .cost = New MaterialSet(450, 0, 0, 0), .Time = 50, .Need = "?MS ?Type:Purger_Dronner", .Effect = "!Sum:Purger_Drone_2", .Install = False, .Desc = "Build a combat drone."})
        Upgrades.Add(New Upgrade With {.Name = "Purger_Drone_3", .File = "Purger_Drone_3", .PTN = New Point(0, 0), .cost = New MaterialSet(475, 0, 0, 0), .Time = 50, .Need = "?MS ?Type:Purger_Dronner", .Effect = "!Sum:Purger_Drone_3", .Install = False, .Desc = "Build a combat drone."})

        'Bases
        Upgrades.Add(New Upgrade With {.Name = "Spawn_Outpost", .File = "Outpost", .PTN = New Point(0, 0), .cost = New MaterialSet(1050, 3, 0, 0), .Time = 260, .Need = "?MS ?Type:Colonizer", .Effect = "!Sum:Outpost", .Install = False, .Desc = "Build a slow mining outpost."})
        Upgrades.Add(New Upgrade With {.Name = "Spawn_Defense", .File = "Defense", .PTN = New Point(0, 0), .cost = New MaterialSet(1350, 3, 0, 0), .Time = 220, .Need = "?MS ?Type:Colonizer", .Effect = "!Sum:Defense", .Install = False, .Desc = "Build an high range defense turret."})
        Upgrades.Add(New Upgrade With {.Name = "Spawn_Pointvortex", .File = "Pointvortex", .PTN = New Point(0, 0), .cost = New MaterialSet(1550, 3, 0, 50), .Time = 220, .Need = "?MS ?Type:Colonizer", .Effect = "!Sum:Pointvortex", .Install = False, .Desc = "Slow and highest range turret."})

        Upgrades.Add(New Upgrade With {.Name = "Factor_PartialBomber", .File = "PartialBomber", .PTN = New Point(0, 0), .cost = New MaterialSet(600, 0, 0, 25), .Time = 2700, .Need = "?MS ?Type:BomberFactory", .Effect = "!Sum:PartialBomber", .Install = False, .Desc = ""})
    End Sub
