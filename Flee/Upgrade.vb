Public Class Upgrade
    ...
    Public Shared Sub LoadRegUpgrades()
        ...
        ' paints
        upgrades.Add(New Upgrade With {.name = "Paint_1", .file = "Ups", .frame_coords = New Point(5, 1), .cost = New MaterialSet(0, 0, 0, 0), .delay = 25, .need = "?Type:Nothing", .effect = "!C:Lime", .upgrade_slots_requiered = 0, .not_for_bots = True, .desc = "Apply paint."})
        upgrades.Add(New Upgrade With {.name = "Paint_2", .file = "Ups", .frame_coords = New Point(5, 2), .cost = New MaterialSet(0, 0, 0, 0), .delay = 25, .need = "?Type:Nothing", .effect = "!C:Cyan", .upgrade_slots_requiered = 0, .not_for_bots = True, .desc = "Apply paint."})
        upgrades.Add(New Upgrade With {.name = "Paint_3", .file = "Ups", .frame_coords = New Point(5, 3), .cost = New MaterialSet(0, 0, 0, 0), .delay = 25, .need = "?Type:Nothing", .effect = "!C:Yellow", .upgrade_slots_requiered = 0, .not_for_bots = True, .desc = "Apply paint."})
        upgrades.Add(New Upgrade With {.name = "Paint_4", .file = "Ups", .frame_coords = New Point(5, 4), .cost = New MaterialSet(0, 0, 0, 0), .delay = 25, .need = "?Type:Nothing", .effect = "!C:Orange", .upgrade_slots_requiered = 0, .not_for_bots = True, .desc = "Apply paint."})
        upgrades.Add(New Upgrade With {.name = "Paint_5", .file = "Ups", .frame_coords = New Point(5, 5), .cost = New MaterialSet(0, 0, 0, 0), .delay = 25, .need = "?Type:Nothing", .effect = "!C:Blue", .upgrade_slots_requiered = 0, .not_for_bots = True, .desc = "Apply paint."})
        upgrades.Add(New Upgrade With {.name = "Paint_6", .file = "Ups", .frame_coords = New Point(5, 6), .cost = New MaterialSet(0, 0, 0, 0), .delay = 25, .need = "?Type:Nothing", .effect = "!C:White", .upgrade_slots_requiered = 0, .not_for_bots = True, .desc = "Apply paint."})
        upgrades.Add(New Upgrade With {.name = "Paint_7", .file = "Ups", .frame_coords = New Point(5, 7), .cost = New MaterialSet(0, 0, 0, 0), .delay = 25, .need = "?Type:Nothing", .effect = "!C:DimGray", .upgrade_slots_requiered = 0, .not_for_bots = True, .desc = "Apply paint."})
        ...
        upgrades.Add(New Upgrade With {.name = "Jump_II", .file = "Ups2", .frame_coords = New Point(0, 3), .cost = New MaterialSet(0, 1, 0, 25), .delay = 200, .need = "?Up:Jump_Engine_II", .effect = "!Jump:82", .upgrade_slots_requiered = 0, .desc = "Higher Jump, but takes longer to load."})
        upgrades.Add(New Upgrade With {.name = "Warp", .file = "Ups2", .frame_coords = New Point(0, 5), .cost = New MaterialSet(0, 1, 0, 50), .delay = 250, .need = "?Up:Warp_Drive", .effect = "!Teleport:1", .upgrade_slots_requiered = 0, .desc = "Warp anywhere. " & vbNewLine & "This jump takes a while to load."})
        ...
        upgrades.Add(New Upgrade With {.name = "Reload_Shield", .file = "Ups", .frame_coords = New Point(5, 0), .cost = New MaterialSet(0, 0, 1, 0), .delay = 50, .need = "?Up:Auto_Nanobots", .effect = "!FixSFull", .upgrade_slots_requiered = 0, .desc = "Help fixing the shield"})
        ...
        upgrades.Add(New Upgrade With {.name = "Ascend", .file = "Ups", .frame_coords = New Point(7, 7), .cost = New MaterialSet(4096, 32, 16, 1024), .delay = 600, .need = "?Up:Warp_Drive", .effect = "!Ascend %Speed:300 %Life:100 !Regen:16 %Wloadmax:-100 !Shield:600 !Shieldop:100 !C:White %Shieldreg:2500", .upgrade_slots_requiered = 1, .not_for_bots = True, .desc = "Warp your mind to an alternative universe and reach the next level of existence."})
        ...
        ' deflectors
        upgrades.Add(New Upgrade With {.name = "Deflector", .file = "EFF_Deflected", .frame_coords = New Point(0, 0), .cost = New MaterialSet(400, 1, 0, 25), .delay = 200, .need = "", .effect = "!Deflector:1", .upgrade_slots_requiered = 1, .desc = "As an alternative to shields, this device block any projectile, but is very slow to reload." & vbNewLine & "Due to the way it works, It is not efficient against fast reloading weapons."})
        upgrades.Add(New Upgrade With {.name = "Deflector_II", .file = "EFF_Deflected", .frame_coords = New Point(1, 0), .cost = New MaterialSet(500, 2, 0, 25), .delay = 200, .need = "+Lvl:2" & NPU(), .effect = "!Deflector:1", .upgrade_slots_requiered = 1, .desc = "Block another projectile."})
        upgrades.Add(New Upgrade With {.name = "Deflector_III", .file = "EFF_Deflected", .frame_coords = New Point(2, 0), .cost = New MaterialSet(600, 4, 0, 25), .delay = 200, .need = "" & NPU(), .effect = "!Deflector:1", .upgrade_slots_requiered = 1, .desc = "Block another projectile."})
        upgrades.Add(New Upgrade With {.name = "Deflector_IV", .file = "EFF_Deflected", .frame_coords = New Point(3, 0), .cost = New MaterialSet(7000, 8, 0, 25), .delay = 200, .need = "" & NPU(), .effect = "!Deflector:1", .upgrade_slots_requiered = 1, .desc = "Block another projectile."})
        upgrades.Add(New Upgrade With {.name = "Hot_Deflector", .file = "EFF_Deflected2", .frame_coords = New Point(4, 0), .cost = New MaterialSet(900, 3, 0, 100), .delay = 200, .need = "?Up:Deflector", .effect = "!HotDeflector:8", .upgrade_slots_requiered = 1, .desc = "This unreliable device was create in an attempt to fix the Deflector vulnerabilities."})
        upgrades.Add(New Upgrade With {.name = "Hot_Deflector_II", .file = "EFF_Deflected2", .frame_coords = New Point(5, 0), .cost = New MaterialSet(1100, 3, 0, 100), .delay = 200, .need = "+Lvl:2" & NPU(), .effect = "!HotDeflector:8", .upgrade_slots_requiered = 1, .desc = "The Hot Deflector is twice as reliable."})
        upgrades.Add(New Upgrade With {.name = "Cold_Deflector", .file = "EFF_Deflected3", .frame_coords = New Point(7, 0), .cost = New MaterialSet(2300, 6, 0, 150), .delay = 200, .need = "+Lvl:2 ?Up:Deflector", .effect = "!ColdDeflector:1", .upgrade_slots_requiered = 1, .desc = "This deflector is able to catch an incredible amount of fire, but prevent your weapons from reloading while it is recovering, AndAlso cause damage to your hull from the inside."})
        ...
        upgrades.Add(New Upgrade With {.name = "Conceive_Legend_I", .file = "Legend_I", .frame_coords = New Point(0, 0), .cost = New MaterialSet(1400, 16, 0, 600), .delay = 650, .need = "?MS ?Type:Station", .effect = "!Sum:Legend_I", .upgrade_slots_requiered = 1, .desc = "Build a legendary ship." & vbNewLine & "/!\ You can only build this ship once!"})
