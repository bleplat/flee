Public Class Upgrade
    ...
    Public Shared Sub LoadRegUpgrades()
        ...
        ' other spawns
        upgrades.Add(New Upgrade With {.name = "Launch_MSL", .file = "MSL", .frame_coords = New Point(0, 0), .cost = New MaterialSet(400, 0, 0, 50), .delay = 100, .need = "?Type:Scout", .effect = "!Sum:MSL", .upgrade_slots_requiered = 0, .desc = "Launch a missile you can control"})
