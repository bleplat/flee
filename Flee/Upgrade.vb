Public Class Upgrade
    ...
    Public Shared Sub LoadRegUpgrades()
        ...
        Upgrades.Add(New Upgrade With {.Name = "Spawn_Pointvortex", .File = "Pointvortex", .PTN = New Point(0, 0), .cost = New MaterialSet(1550, 3, 0, 50), .Time = 220, .Need = "?MS ?Type:Colonizer", .Effect = "!Sum:Pointvortex", .Install = False, .Desc = "Slow AndAlso highest range turret."})
