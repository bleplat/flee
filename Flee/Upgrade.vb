Public Class Upgrade
    ...
    Public Shared Sub LoadRegUpgrades()
        ...
        Upgrades.Add(New Upgrade With {.Name = "Build_Crusher", .File = "Crusher", .PTN = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .Time = 2500, .Need = "?Up:Nothing", .Effect = "!Sum:Crusher", .Install = False, .Desc = "It's gonna hurt!" & vbNewLine & "'Hmm... How could you even read this?'"})
        ...
        Upgrades.Add(New Upgrade With {.Name = "Build_Legend_I", .File = "Legend_I", .PTN = New Point(0, 0), .cost = New MaterialSet(1400, 16, 1, 0), .Time = 550, .Need = "?MS ?Type:Station", .Effect = "!Sum:Legend_I", .Install = True, .Desc = "Build a legendary ship." & vbNewLine & "/!\ You can only build this ship once!"})
        Upgrades.Add(New Upgrade With {.Name = "Build_Legend_K", .File = "Legend_K", .PTN = New Point(0, 0), .cost = New MaterialSet(1200, 14, 0, 400), .Time = 550, .Need = "?MS ?Type:Station", .Effect = "!Sum:Legend_K", .Install = True, .Desc = "Build a legendary ship." & vbNewLine & "/!\ You can only build this ship once!"})
        Upgrades.Add(New Upgrade With {.Name = "Build_Legend_L", .File = "Legend_L", .PTN = New Point(0, 0), .cost = New MaterialSet(1300, 15, 0, 400), .Time = 550, .Need = "?MS ?Type:Station", .Effect = "!Sum:Legend_L", .Install = True, .Desc = "Build a legendary ship." & vbNewLine & "/!\ You can only build this ship once!"})
        Upgrades.Add(New Upgrade With {.Name = "Build_Legend_U", .File = "Legend_U", .PTN = New Point(0, 0), .cost = New MaterialSet(1200, 16, 0, 200), .Time = 550, .Need = "?MS ?Type:Station", .Effect = "!Sum:Legend_U", .Install = True, .Desc = "Build a legendary ship." & vbNewLine & "/!\ You can only build this ship once!"})
        Upgrades.Add(New Upgrade With {.Name = "Build_Legend_Y", .File = "Legend_Y", .PTN = New Point(0, 0), .cost = New MaterialSet(1400, 14, 0, 300), .Time = 550, .Need = "?MS ?Type:Station", .Effect = "!Sum:Legend_Y", .Install = True, .Desc = "Build a legendary ship." & vbNewLine & "/!\ You can only build this ship once!"})
