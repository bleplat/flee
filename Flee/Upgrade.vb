Public Class Upgrade
    ...
    Public Shared Sub LoadRegUpgrades()
        ...
        upgrades.Add(New Upgrade With {.name = "Build_Kastou", .file = "Kastou", .frame_coords = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .delay = 1500, .need = "?Up:Nothing", .effect = "!Sum:Kastou", .upgrade_slots_requiered = 0, .desc = "Ya kastou itsi vioctry granti" & vbNewLine & "'yi granti!'"})
        upgrades.Add(New Upgrade With {.name = "Build_Crusher", .file = "Crusher", .frame_coords = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .delay = 3500, .need = "?Up:Nothing", .effect = "!Sum:Crusher", .upgrade_slots_requiered = 0, .desc = "It's gonna hurt!" & vbNewLine & "'Hmm... How could you even read this?'"})
        upgrades.Add(New Upgrade With {.name = "Build_Ori", .file = "Ori", .frame_coords = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .delay = 100, .need = "?Up:Nothing", .effect = "!Sum:Ori", .upgrade_slots_requiered = 0, .desc = "Hey"})
        ...
        'BASE Spawn
        upgrades.Add(New Upgrade With {.name = "Build_Cargo", .file = "Cargo", .frame_coords = New Point(0, 0), .cost = New MaterialSet(1200, 0, 0, 0), .delay = 300, .need = "?MS ?Type:Station", .effect = "!Sum:Cargo", .upgrade_slots_requiered = 0, .desc = "Build a weak but fast mining ship." & vbNewLine & "'An overpowered ship.'"})
        upgrades.Add(New Upgrade With {.name = "Build_Hunter", .file = "Hunter", .frame_coords = New Point(0, 0), .cost = New MaterialSet(800, 1, 0, 0), .delay = 220, .need = "?MS ?Type:Station", .effect = "!Sum:Hunter", .upgrade_slots_requiered = 0, .desc = "Build a light hunter ship."})
        upgrades.Add(New Upgrade With {.name = "Build_Harass", .file = "Harass", .frame_coords = New Point(0, 0), .cost = New MaterialSet(950, 2, 0, 0), .delay = 350, .need = "?MS ?Type:Station", .effect = "!Sum:Harass", .upgrade_slots_requiered = 0, .desc = "Build a medium hunter ship."})
        upgrades.Add(New Upgrade With {.name = "Build_Simpleship", .file = "Simpleship", .frame_coords = New Point(0, 0), .cost = New MaterialSet(1000, 1, 0, 0), .delay = 380, .need = "?MS ?Type:Station", .effect = "!Sum:Simpleship", .upgrade_slots_requiered = 0, .desc = "Build a basic ship that you can upgrade."})
        upgrades.Add(New Upgrade With {.name = "Build_Legend_I", .file = "Legend_I", .frame_coords = New Point(0, 0), .cost = New MaterialSet(1400, 16, 1, 0), .delay = 650, .need = "?MS ?Type:Station", .effect = "!Sum:Legend_I", .upgrade_slots_requiered = 1, .desc = "Build a legendary ship." & vbNewLine & "/!\ You can only build this ship once!"})
        upgrades.Add(New Upgrade With {.name = "Build_Legend_K", .file = "Legend_K", .frame_coords = New Point(0, 0), .cost = New MaterialSet(1200, 14, 0, 400), .delay = 650, .need = "?MS ?Type:Station", .effect = "!Sum:Legend_K", .upgrade_slots_requiered = 1, .desc = "Build a legendary ship." & vbNewLine & "/!\ You can only build this ship once!"})
        upgrades.Add(New Upgrade With {.name = "Build_Legend_L", .file = "Legend_L", .frame_coords = New Point(0, 0), .cost = New MaterialSet(1300, 15, 0, 400), .delay = 650, .need = "?MS ?Type:Station", .effect = "!Sum:Legend_L", .upgrade_slots_requiered = 1, .desc = "Build a legendary ship." & vbNewLine & "/!\ You can only build this ship once!"})
        upgrades.Add(New Upgrade With {.name = "Build_Legend_U", .file = "Legend_U", .frame_coords = New Point(0, 0), .cost = New MaterialSet(1200, 16, 0, 200), .delay = 650, .need = "?MS ?Type:Station", .effect = "!Sum:Legend_U", .upgrade_slots_requiered = 1, .desc = "Build a legendary ship." & vbNewLine & "/!\ You can only build this ship once!"})
        upgrades.Add(New Upgrade With {.name = "Build_Legend_Y", .file = "Legend_Y", .frame_coords = New Point(0, 0), .cost = New MaterialSet(1400, 14, 0, 300), .delay = 650, .need = "?MS ?Type:Station", .effect = "!Sum:Legend_Y", .upgrade_slots_requiered = 1, .desc = "Build a legendary ship." & vbNewLine & "/!\ You can only build this ship once!"})

        'NPC Spawn
        upgrades.Add(New Upgrade With {.name = "Build_Dronner", .file = "Dronner", .frame_coords = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .delay = 750, .need = "?Up:Nothing", .effect = "!Sum:Dronner", .upgrade_slots_requiered = 0, .desc = "Construire un constructeur de drones"})
        upgrades.Add(New Upgrade With {.name = "Build_Scout", .file = "Scout", .frame_coords = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .delay = 550, .need = "?Up:Nothing", .effect = "!Sum:Scout", .upgrade_slots_requiered = 0, .desc = "Construire un vaisseau d'exploration"})
        upgrades.Add(New Upgrade With {.name = "Build_Bomber", .file = "Bomber", .frame_coords = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .delay = 550, .need = "?Up:Nothing", .effect = "!Sum:Bomber", .upgrade_slots_requiered = 0, .desc = "Construire un vaisseau lourd"})
        upgrades.Add(New Upgrade With {.name = "Build_Yerka", .file = "Yerka", .frame_coords = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .delay = 720, .need = "?Up:Nothing", .effect = "!Sum:Yerka", .upgrade_slots_requiered = 0, .desc = "Ya Yerka Yi!"})
        upgrades.Add(New Upgrade With {.name = "Build_Strange", .file = "Strange", .frame_coords = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .delay = 850, .need = "?Up:Nothing", .effect = "!Sum:Strange", .upgrade_slots_requiered = 0, .desc = ""})
        upgrades.Add(New Upgrade With {.name = "Build_Sacred", .file = "Sacred", .frame_coords = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .delay = 200, .need = "?Up:Nothing", .effect = "!Sum:Sacred", .upgrade_slots_requiered = 0, .desc = ""})
        upgrades.Add(New Upgrade With {.name = "Build_Artillery", .file = "Artillery", .frame_coords = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .delay = 270, .need = "?Up:Nothing", .effect = "!Sum:Artillery", .upgrade_slots_requiered = 0, .desc = ""})
        upgrades.Add(New Upgrade With {.name = "Build_MiniColonizer", .file = "MiniColonizer", .frame_coords = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .delay = 500, .need = "?Up:Nothing", .effect = "!Sum:MiniColonizer", .upgrade_slots_requiered = 0, .desc = ""})
        upgrades.Add(New Upgrade With {.name = "Build_Colonizer", .file = "Colonizer", .frame_coords = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .delay = 500, .need = "?Up:Nothing", .effect = "!Sum:Colonizer", .upgrade_slots_requiered = 0, .desc = ""})
        upgrades.Add(New Upgrade With {.name = "Build_Converter_A", .file = "Converter_A", .frame_coords = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .delay = 220, .need = "?Type:Converter", .effect = "!Sum:Converter_A", .upgrade_slots_requiered = 0, .desc = ""})
        upgrades.Add(New Upgrade With {.name = "Build_Converter_B", .file = "Converter_B", .frame_coords = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .delay = 220, .need = "?Type:Converter", .effect = "!Sum:Converter_B", .upgrade_slots_requiered = 0, .desc = ""})

        'Drone Spawn
        upgrades.Add(New Upgrade With {.name = "Build_Explorer", .file = "Explorer", .frame_coords = New Point(0, 0), .cost = New MaterialSet(100, 0, 0, 0), .delay = 150, .need = "?MS ?Type:Dronner", .effect = "!Sum:Explorer", .upgrade_slots_requiered = 0, .desc = "Build a weak minner drone."})
        upgrades.Add(New Upgrade With {.name = "Build_Combat_Drone_1", .file = "Combat_Drone_1", .frame_coords = New Point(0, 0), .cost = New MaterialSet(370, 0, 0, 0), .delay = 100, .need = "?MS ?Type:Dronner", .effect = "!Sum:Combat_Drone_1", .upgrade_slots_requiered = 0, .desc = "Build a combat drone."})
        upgrades.Add(New Upgrade With {.name = "Build_Combat_Drone_2", .file = "Combat_Drone_2", .frame_coords = New Point(0, 0), .cost = New MaterialSet(320, 0, 0, 0), .delay = 100, .need = "?MS ?Type:Dronner", .effect = "!Sum:Combat_Drone_2", .upgrade_slots_requiered = 0, .desc = "Build a combat drone."})
        upgrades.Add(New Upgrade With {.name = "Build_Combat_Drone_3", .file = "Combat_Drone_3", .frame_coords = New Point(0, 0), .cost = New MaterialSet(380, 0, 0, 0), .delay = 100, .need = "?MS ?Type:Dronner", .effect = "!Sum:Combat_Drone_3", .upgrade_slots_requiered = 0, .desc = "Build a combat drone."})
        upgrades.Add(New Upgrade With {.name = "Build_Drone", .file = "Drone", .frame_coords = New Point(0, 0), .cost = New MaterialSet(800, 1, 0, 0), .delay = 150, .need = "?MS ?Type:Dronner", .effect = "!Sum:Drone", .upgrade_slots_requiered = 0, .desc = "Summon a big drone."})
        ...
        upgrades.Add(New Upgrade With {.name = "Build_Purger_Dronner", .file = "Purger_Dronner", .frame_coords = New Point(0, 0), .cost = New MaterialSet(0, 0, 0, 0), .delay = 2400, .need = "?Up:Nothing", .effect = "!Sum:Purger_Dronner", .upgrade_slots_requiered = 0, .desc = ""})
        upgrades.Add(New Upgrade With {.name = "Build_Purger_Drone_1", .file = "Purger_Drone_1", .frame_coords = New Point(0, 0), .cost = New MaterialSet(400, 0, 0, 0), .delay = 50, .need = "?MS ?Type:Purger_Dronner", .effect = "!Sum:Purger_Drone_1", .upgrade_slots_requiered = 0, .desc = "Build a combat drone."})
        upgrades.Add(New Upgrade With {.name = "Build_Purger_Drone_2", .file = "Purger_Drone_2", .frame_coords = New Point(0, 0), .cost = New MaterialSet(450, 0, 0, 0), .delay = 50, .need = "?MS ?Type:Purger_Dronner", .effect = "!Sum:Purger_Drone_2", .upgrade_slots_requiered = 0, .desc = "Build a combat drone."})
        upgrades.Add(New Upgrade With {.name = "Build_Purger_Drone_3", .file = "Purger_Drone_3", .frame_coords = New Point(0, 0), .cost = New MaterialSet(475, 0, 0, 0), .delay = 50, .need = "?MS ?Type:Purger_Dronner", .effect = "!Sum:Purger_Drone_3", .upgrade_slots_requiered = 0, .desc = "Build a combat drone."})

        'Bases
        upgrades.Add(New Upgrade With {.name = "Build_Outpost", .file = "Outpost", .frame_coords = New Point(0, 0), .cost = New MaterialSet(1050, 3, 0, 0), .delay = 260, .need = "?MS ?Type:Colonizer", .effect = "!Sum:Outpost", .upgrade_slots_requiered = 0, .desc = "Build a slow mining outpost."})
        upgrades.Add(New Upgrade With {.name = "Build_Defense", .file = "Defense", .frame_coords = New Point(0, 0), .cost = New MaterialSet(1350, 3, 0, 0), .delay = 220, .need = "?MS ?Type:Colonizer", .effect = "!Sum:Defense", .upgrade_slots_requiered = 0, .desc = "Build an high range defense turret."})
        upgrades.Add(New Upgrade With {.name = "Build_Pointvortex", .file = "Pointvortex", .frame_coords = New Point(0, 0), .cost = New MaterialSet(1550, 3, 0, 50), .delay = 220, .need = "?MS ?Type:Colonizer", .effect = "!Sum:Pointvortex", .upgrade_slots_requiered = 0, .desc = "Slow AndAlso highest range turret."})
